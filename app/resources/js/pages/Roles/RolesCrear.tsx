    ...
    return (
        <MainLayout>
            ...
            <div className="max-w-[800px] mx-auto p-6 lg:p-8">
                ...
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-white mb-1">Crear Rol</h1>
                    <p className="text-[#7a7f85] text-sm">Define un nuevo rol y sus permisos.</p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            {(!permisos || permisos.length === 0) && (
                                <p className="text-[#7a7f85] text-sm col-span-2">No hay permisos creados todavía.</p>
                            )}
                        </div>
                    </div>
