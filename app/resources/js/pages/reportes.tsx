...
export default function TarjetasPareCrear() {
    ...
    return (
        <MainLayout>
            ...
            <div className="max-w-[1700px] mx-auto p-6 lg:p-8 mt-4 lg:mt-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-4 gap-8 mt">
                    <div className="xl:col-span-1">
                        {/* Lado izquierdo */}
                        <div className="bg-[#111111] border border-[#2d3238] rounded-2xl p-6 shadow-xl sticky top-24">
                    ...
                    {/* Centro */}
                    <div className="xl:col-span-2 bg-[#141414] border border-[#2d3238] rounded-2xl p-8 shadow-2xl">
