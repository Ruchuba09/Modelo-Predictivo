...
export default function PermisosEditar() {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/permisos/${permiso.id_permiso}`);
    };

    return (
        <MainLayout>
            <Head title={`Editar Permiso #${permiso.id_permiso} | AVA`} />
            ...
            <div className="max-w-[600px] mx-auto p-6 lg:p-8">
                ...
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-white mb-1">Editar Permiso</h1>
                    <p className="text-[#7a7f85] text-sm">Modifica el permiso #{permiso.id_permiso}.</p>
                </div>
