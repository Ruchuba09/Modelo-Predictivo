...
export default function EscalaRiesgoCrear() {
    ...
    return (
        <MainLayout>
            <Head title="Crear Escala de Riesgo | AVA" />
            ...
            <div className="max-w-[600px] mx-auto p-6 lg:p-8">
                ...
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-white mb-1">Crear Escala de Riesgo</h1>
                    <p className="text-[#7a7f85] text-sm">Define un nuevo nivel de riesgo.</p>
                </div>
                ...
                <form onSubmit={submit} className="bg-[#15181c] border border-white/5 rounded-xl p-6 lg:p-8 space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-white mb-2">Valor (orden numérico)</label>
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-white/5">
                        ...
                        <button type="submit" disabled={processing} className="bg-[#a0f700] hover:bg-[#86cf00] disabled:opacity-50 text-black px-5 py-2.5 rounded-lg text-sm font-bold transition-colors shadow-lg shadow-[#a0f700]/10">
                            {processing ? 'Creando...' : 'Crear Escala'}
                        </button>
                    </div>
